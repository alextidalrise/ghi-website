...
<section class="guides" aria-labelledby="guides-heading">
	<div class="guides__inner">
		<div class="guides__text">
			...
			<h2 id="guides-heading" class="guides__title">Everything to know <em>before you buy</em></h2>
			<p class="guides__deck">
				The process, the costs, the tax and the mortgage — set out plainly for non-resident
				buyers in Spain and Portugal.
			</p>
		</div>
