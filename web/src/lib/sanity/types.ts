...
// Query: *[    _type == "locationTaxonomy"    && type == "country"    && slug.current == $countrySlug  ][0]{  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}
...
// Query: *[    _type == "locationTaxonomy"    && type == "location"    && slug.current == $locationSlug    && parent->slug.current == $countrySlug  ][0]{  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}
...
// Query: *[    _type == "locationTaxonomy"    && type == "location"    && slug.current == $locationSlug    && parent->slug.current == $countrySlug  ][0]{    _id,    name,    "slug": slug.current,    type,    breadcrumbLabel,    seoTitle,    metaDescription,    publicDescription,    heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},    tagline,    linkedLocations[]{      includeInGrid,      showLink,      location->{        _id,        name,        "slug": slug.current,        breadcrumbLabel      }    }  }
...
// Query: *[    _type == "locationTaxonomy"    && type == "community"    && slug.current == $communitySlug    && (      parent._ref == $locationId      || $locationId in associatedLocations[]._ref    )  ][0]{  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}
...
// Query: *[    _type == "locationTaxonomy"    && type == "location"    && parent->slug.current == $countrySlug  ] | order(name asc){  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}
...
// Query: *[_id == $taxonomyId][0]{    "chain": [      ...*[_id == ^._id][0].parent->parent->{  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates},      ...*[_id == ^._id][0].parent->{  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates},      {  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}    ][defined(name)]  }
...
// Query: *[    _type == "locationTaxonomy"    && type == "country"    && defined(slug.current)    && defined(heroImage.asset)  ] | order(name asc){  _id,  name,  "slug": slug.current,  type,  breadcrumbLabel,  seoTitle,  metaDescription,  publicDescription,  heroImage{  asset,  fileAsset,  assetCategory,  order,  altText},  tagline,  coordinates}
