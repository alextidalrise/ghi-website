    ...
    body: Array<
      ...
      | {
          ...
          items: Array<{
            ...
            completionDate: Array<string | null>;
          }>;
        }
      | {
          _key: string;
